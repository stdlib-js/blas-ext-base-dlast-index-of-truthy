...
var dindexOfTruthy = require( '@stdlib/blas-ext-base-dindex-of-truthy' ).ndarray;
...
*
* var idx = dlastIndexOfTruthy( x.length, x, 1, 0 );
* // returns 7
*/
function dlastIndexOfTruthy( N, x, strideX, offsetX ) {
	var idx;
	...
	idx = dindexOfTruthy( N, x, strideX, offsetX );
	if ( idx < 0 ) {
		return idx;
	}
...
module.exports = dlastIndexOfTruthy;
